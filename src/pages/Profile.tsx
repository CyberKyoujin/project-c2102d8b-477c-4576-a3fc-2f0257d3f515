...
import { 
  ...
  Clock, CheckCircle, Loader2, Syringe, Settings, LogOut, ChevronRight
} from "lucide-react";
                  ...
                  {orders.map((order) => {
                    ...
                    return (
                      <Link
                        ...
                        className="block w-full text-left bg-card rounded-2xl p-6 shadow-soft hover:shadow-card transition-all hover:scale-[1.01]"
                      >
